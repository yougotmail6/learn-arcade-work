...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.barrack_list = arcade.SpriteList()
        ...
        for x in range(100, 15500, random.randrange(64,600)):
