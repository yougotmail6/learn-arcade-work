...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        self.bad_music = arcade.load_sound("Wrong Buzzer Sound Effect.wav")

        # Set up the player
        # Character image from kenney.nl
        self.player_sprite = arcade.Sprite("scifiUnit_11.png", SPRITE_SCALING_PLAYER)
        ...
        for i in range(COIN_COUNT):
            ...
            coin = arcade.Sprite("scifiEnvironment_13.png", SPRITE_SCALING_COIN)
            ...
            # Create the coin instance
            # Coin image from kenney.nl
                bad = arcade.Sprite("tile_0015.png", SPRITE_SCALING_BAD)
