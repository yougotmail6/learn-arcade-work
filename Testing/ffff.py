...
def main():
    ...
    while done == False:
        ...
        if Camel_Tiredness > 8:
            print(
                "You know you not only stole a Camel, but also killed one to? Yeah I know, such a perfect example of Animal Abuse in the Wild! I'm just disappointed really. ")
            done = True
        ...
        if miles_traveled - natives > natives_close_by:
